...
working_dir='/mnt/data/apandey/op313_latest/crab_data'
table='/mnt/data/IRFs/v6/lt_2425w_CARE162d12_v259rc0_05off_Z00-60_d1p43_4nsb.root'
template='/mnt/data/IRFs/v6/TemplateList_CARE_V6_ATM61_seas2425w.txt'
...
cp -v {working_dir}/out/stg2/{obs_id}_stg2.root {working_dir}/med_cuts/out/stg4/{obs_id}_soft_0p5off_ITMgeo_stg4.root >> {working_dir}/med_cuts/log/{obs_id}_soft_0p5off_ITMgeo_stg4.log

vaStage4 -DistanceUpper=0/1.43 -SizeLower=0/700 -NTubesMin=0/5 -table={table} -ITM_MSW_Upper=1.1 -ITM_MSL_Upper=1.3 -ITM_NpeMin=3 -ITM_NpeMax=300  -M3D_Algorithm=ImageTemplateModel -ITM_templateList={template} {working_dir}/med_cuts/out/stg4/{obs_id}_soft_0p5off_ITMgeo_stg4.root >> {working_dir}/med_cuts/log/{obs_id}_soft_0p5off_ITMgeo_stg4.log 2>&1
