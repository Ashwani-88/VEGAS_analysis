...
vaStage1 -Stage1_RunMode=flasher {data_dir}/{obs_id}.cvbf {working_dir}/out/stg1/{obs_id}_flasher.root >> {working_dir}/log/{obs_id}_laser.log 2>&1
echo "Done processing observation ID:  {obs_id}"
"""
